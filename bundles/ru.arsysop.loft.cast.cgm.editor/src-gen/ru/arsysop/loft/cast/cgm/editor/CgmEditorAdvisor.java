...
import ru.arsysop.loft.cast.cgm.editor.CgmEditorPlugin;
 ...
 * @generated
 */
public final class CgmEditorAdvisor extends WorkbenchAdvisor {
	/**
	 ...
	 * @generated NOT
	 */
	private static final String[] FILE_EXTENSION_FILTERS = new String[] {"*.cgm_json", "*.json"}; 
	...
	private static String getString(String key, Object s1) {
		return ru.arsysop.loft.cast.cgm.editor.CgmEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
	...
	public static class Application implements IApplication {
		...
		public Object start(IApplicationContext context) throws Exception {
			WorkbenchAdvisor workbenchAdvisor = new CgmEditorAdvisor();
	...
	public static class Perspective implements IPerspectiveFactory {
		 ...
		 * @generated
		 */
		public static final String ID_PERSPECTIVE = "ru.arsysop.loft.cast.cgm.editor.CgmEditorAdvisorPerspective"; //$NON-NLS-1$
	...
	/**
	 * Open action for the objects from the Cgm model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * Open URI action for the objects from the Cgm model.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
