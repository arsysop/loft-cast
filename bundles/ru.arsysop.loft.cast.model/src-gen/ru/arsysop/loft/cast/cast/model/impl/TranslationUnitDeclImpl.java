 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.cast.cast.model.impl.TranslationUnitDeclImpl#getDeclarations <em>Declarations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TranslationUnitDeclImpl extends NamedDeclImpl implements TranslationUnitDecl {
	...
	protected EClass eStaticClass() {
		return CastPackage.eINSTANCE.getTranslationUnitDecl();
	}
	...
	public EList<NamedDecl> getDeclarations() {
		if (declarations == null) {
			declarations = new EObjectResolvingEList<NamedDecl>(NamedDecl.class, this, CastPackage.TRANSLATION_UNIT_DECL__DECLARATIONS);
		}
		return declarations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CastPackage.TRANSLATION_UNIT_DECL__DECLARATIONS:
