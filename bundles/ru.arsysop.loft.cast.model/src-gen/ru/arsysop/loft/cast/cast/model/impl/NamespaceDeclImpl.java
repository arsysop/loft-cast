 ...
 * </p>
 * <ul>
 *   <li>{@link ru.arsysop.loft.cast.cast.model.impl.NamespaceDeclImpl#getDeclarations <em>Declarations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamespaceDeclImpl extends NamedDeclImpl implements NamespaceDecl {
	...
	protected EClass eStaticClass() {
		return CastPackage.eINSTANCE.getNamespaceDecl();
	}
	...
	public EList<NamedDecl> getDeclarations() {
		if (declarations == null) {
			declarations = new EObjectResolvingEList<NamedDecl>(NamedDecl.class, this, CastPackage.NAMESPACE_DECL__DECLARATIONS);
		}
		return declarations;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CastPackage.NAMESPACE_DECL__DECLARATIONS:
